...
const slides = [
  {
    ...
    icon: (
      <svg viewBox="0 0 120 120" className="h-32 w-32" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        <path d="M90 20a12 12 0 01-8-4M100 30a12 12 0 01-8-4" strokeWidth="1.5" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 120 120" className="h-32 w-32" fill="none" stroke="currentColor" strokeWidth="1.5">
        <path d="M60 12L20 28v20c0 28 16 48 40 56 24-8 40-28 40-56V28L60 12z" strokeWidth="2" />
...
export default function WelcomeSlides() {
  ...
  const skip = () => {
    localStorage.setItem('dr-saina-onboarding-done', 'true')

...
DOCTORS = (
    ('09121110001', 'دکتر سارا', 'محمدی', 'sara', 'cardio', 'تهران', 'بیمارستان دی', 12, 4.9, 318, 250000, 'approved', 'متخصص قلب و عروق با تخصص در اکوکاردیوگرافی و فشار خون.', (('شنبه', '08:00', '14:00'), ('دوشنبه', '08:00', '14:00'))),
    ('09121110002', 'دکتر علی', 'رضایی', 'ali', 'neuro', 'تهران', 'بیمارستان میلاد', 9, 4.7, 142, 300000, 'approved', 'نورولوژیست با تخصص در میگرن و اختلالات خواب.', (('یکشنبه', '09:00', '15:00'),)),
    ('09121110003', 'دکتر مریم', 'حسینی', 'maryam', 'derma', 'اصفهان', 'کلینیک پوست بهار', 7, 4.8, 205, 200000, 'approved', 'متخصص پوست، مو و زیبایی. درمان جوش و لک.', (('سه‌شنبه', '16:00', '20:00'),)),
    ('09121110004', 'دکتر حسین', 'کریمی', 'hossein', 'ortho', 'شیراز', 'بیمارستان نمازی', 15, 4.6, 289, 280000, 'approved', 'ارتوپد و جراح زانو با سابقه بین‌المللی.', (('چهارشنبه', '08:00', '12:00'),)),
    ('09121110005', 'دکتر نگار', 'اکبری', 'negar', 'ped', 'تهران', 'بیمارستان کودکان مفید', 11, 5.0, 412, 220000, 'approved', 'پزشک متخصص اطفال و نوزادان.', (('شنبه', '10:00', '16:00'),)),
    ('09121110006', 'دکتر رضا', 'قاسمی', 'reza', 'ent', 'مشهد', 'بیمارستان امام رضا', 8, 4.5, 96, 190000, 'pending', 'متخصص گوش، حلق و بینی در انتظار تأیید پروفایل.', (('یکشنبه', '08:00', '13:00'),)),
    ('09121110007', 'دکتر پارسا', 'نوری', 'parsa', 'eye', 'تبریز', 'بیمارستان میلاد', 14, 4.8, 175, 260000, 'suspended', 'چشم پزشک و جراح لیزیک.', (('سه‌شنبه', '09:00', '14:00'),)),
    ('09121110008', 'دکتر لیلا', 'صادقی', 'leila', 'psy', 'تهران', 'کلینیک آرامش', 10, 4.9, 233, 350000, 'approved', 'روان پزشک متخصص اضطراب و افسردگی.', (('شنبه', '14:00', '20:00'),)),
)
